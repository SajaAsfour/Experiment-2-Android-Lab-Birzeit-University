    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                MainActivity.this.startActivity(intent); finish();
            }
        });
        ...
        for(Customer objCustomer : Customer.customersArrayList)
        {
            ...
            txtCustomerInfo.setTextAppearance(com.google.android.material.R.style.TextAppearance_AppCompat_Display2);
            txtCustomerInfo.setText(objCustomer.toString()); secondLinearLayout .addView(txtCustomerInfo); }
    }
}